    ...
    <div class="container px-3 md:px-0">
      ...
      <div v-if="studentDetails.details" class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="group-milestone md:col-span-4 py-5">
          <h3 class="text-2xl font-semibold py-2">GROUP MILESTONE</h3>

          <div class="p-5">
            <ol v-if="studentDetails.details.grouptype.id == 1" class="items-center sm:flex">
              <li v-for="milestone in studentDetails.onemilestones" :key="milestone.id" class="relative mb-6 sm:mb-0">
            ...
            <ol v-if="studentDetails.details.grouptype.id == 2" class="items-center sm:flex">\
              <li v-for="milestone in studentDetails.twomilestones" :key="milestone.id" class="relative mb-6 sm:mb-0">
                <div class="flex items-center">
                  <div
                    class="flex z-10 justify-center items-center w-6 h-6 rounded-full ring-0 ring-white dark:bg-blue-900 sm:ring-8 dark:ring-gray-900 shrink-0" :class="studentDetails.details.group.twomilestone_order >= milestone.order ? 'bg-yellow-200' : 'bg-gray-200'">
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                      xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="31.424px" height="31.425px"
                      viewBox="0 0 31.424 31.425" style="enable-background:new 0 0 31.424 31.425;" xml:space="preserve">
                      <g>
        ...
        <div class="group-details border-l-4 border-yellow-500 py-5 px-3">
          <h3 class="text-2xl font-semibold py-2">GROUP DETAILS</h3>
          <div class="px-2">
        ...
        <div class="group-details border-l-4 border-yellow-500 py-5 px-3">
          <h3 class="text-2xl font-semibold py-2">GROUP MEMBERS</h3>
          <div class="px-2">
        ...
        <div class="group-details border-l-4 border-yellow-500 py-5 px-3">
          <h3 class="text-2xl font-semibold py-2">GROUP ADVISER</h3>
          <div class="px-2">
        ...
        <div class="group-details border-l-4 border-yellow-500 py-5 px-3">
          <h3 class="text-2xl font-semibold py-2">GROUP PANELS</h3>
          <div class="px-2">
